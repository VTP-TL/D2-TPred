...
In the VTP-TL dataset [VTP-TL](URL"https://pan.baidu.com/s/1ecpsxnmtGcZ4X8ckb59wcA"), we have collected data from 3 different categories of traffic scenarios using drones. The summary of the data is listed in the following table. 
